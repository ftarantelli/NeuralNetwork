...
plot  "data_sec0611ntk1000.ddat" every 200 using ($1):($2*90**(0.)):($3) t 'NTKgp' w yerrorlines pt 5 ps 1 lw 3. lt 8 dt 1 pi 100,\
      ".dat" using ($1):($2*50**(0.)) t '' w l lw 3. lt rgb 'blue' dt 5,\
      "Output_ens_sigma_0.01.txt" using ($1):($2*90**(0.)):($3) t 'BG' w yerrorlines pt 3 ps 1 lw 3. dt 3 lt 1,\
      "test.dat" using ($1):(($2)*30**(0.)) t 'smear' w l lw 3. lt rgb 'dark-green' dt 2,\
      "outputNNwidth16sec.ddat" every 200 using ($1):($2*90**(0.)):($3*50) t 'NN' w yerrorlines pt 1 ps 1 lw 3. dt 5 pi 100 lt 6,\
      "data_sec0611nngp1000.dat" every 200 using ($1):($2*70**(0.)):($3) t 'NNGP' w yerrorlines pt 7 ps 1 lw 1. lt rgb 'red' dt 4 pi 100,\
